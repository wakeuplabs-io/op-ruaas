...
export const SEQUENCER_IDS =
  envParsed().MARKETPLACE_SEQUENCER_OFFERS.split(",");
...
export const MARKETPLACE_TOKEN_DECIMALS = 18; // TODO: env var
export const MARKETPLACE_TOKEN_SYMBOL = "TEST";
